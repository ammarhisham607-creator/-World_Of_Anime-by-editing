...
const translations = {
  ar: {
    ...
    'pick-location': 'حدد موقعك على الخريطة', 'location-selected': 'تم تحديد الموقع',
    'location-hint': 'اضغط على الخريطة لتحديد عنوان التوصيل',
    ...
    'login-required-review': 'سجل دخولك الأول عشان تكتب تقييم',
  ...
  en: {
    ...
    'order-success': 'Your order has been placed!', 'order-success-desc': 'We will contact you soon to confirm delivery.',
    'order-id': 'Order ID', 'back-to-home': 'Back to Home',
    'pick-location': 'Pick your location on the map', 'location-selected': 'Location selected',
    'location-hint': 'Click on the map to set your delivery address',
